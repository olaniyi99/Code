...
# fit network
history = model.fit(train_X, train_y, epochs=100, batch_size=24, validation_data=(test_X, test_y), verbose=2, shuffle=False, callbacks=callbacks)
...
plt.plot(train_dates, inv_y, color = 'black', label = 'Actual Load Demand')
plt.plot(train_dates, inv_yhat, color = 'green', label = 'Predicted Load Demand')
