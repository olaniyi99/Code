...
Holiday['Date'] = pd.to_datetime(Holiday['Date'], dayfirst=True)
...
#test_data.loc[Holiday['Date'], 'is_holiday'] = 1
...
#df_final.to_csv('/Users/davidadeyemi/Desktop/FYP/Code/finalvalues.csv')